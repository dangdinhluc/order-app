...
export default function CustomerOrder() {
    ...
    const [language, setLanguage] = useState<'vi' | 'ja' | 'en'>('ja');
    ...
    const getName = (item: { name_vi: string; name_ja?: string; name_en?: string }) => {
        ...
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
                <div className="text-center">
                    ...
                    <h1 className="text-xl font-bold text-white mb-2">エラー / Lỗi</h1>
        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <header className="sticky top-0 z-30 bg-white shadow-sm">
                <div className="px-4 py-3 border-b border-slate-100">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-lg font-bold text-slate-800">🍜 Hybrid POS</h1>
                            <p className="text-sm text-slate-500">
                                {session?.table_name || `テーブル ${tableNum}`}
                            </p>
                        </div>
                    ...
                    {filteredProducts.map(product => (
                        ...
                        >
                            ...
                            <div className="p-3">
                                ...
                                {language !== 'vi' && (
                                    <p className="text-xs text-slate-400 mt-0.5">{product.name_vi}</p>
                                )}
            ...
            {serviceSent && (
                <div className="fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-emerald-500 text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 animate-slide-in">
                    <Check size={20} />
                    <span>スタッフを呼びました！/ Đã gọi nhân viên!</span>
                </div>
            )}
                ...
                <>
                    ...
                    <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-50 max-h-[80vh] overflow-hidden animate-slide-in">
                        <div className="p-4 border-b border-slate-200 flex items-center justify-between">
                            <h2 className="text-lg font-bold">カート / Giỏ hàng</h2>
